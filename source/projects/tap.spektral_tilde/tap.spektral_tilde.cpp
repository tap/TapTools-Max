...
#define TAP_SPEKTRAL_ATTR(NAME, INDEX, DEFAULT, DESC)                                                                  \
    ...
    TAP_SPEKTRAL_ATTR(level, kernel::p_level_master, 1.0, "Master multiplier (0..2) on the per-band level curve.")
    ...
    TAP_SPEKTRAL_ATTR(delayscale, kernel::p_delayscale, 1.0, "Master multiplier (0..2) on the per-band delay curve.")
    ...
    TAP_SPEKTRAL_ATTR(lforate, kernel::p_lforate, 1.0, "LFO rate in Hz (0..20).")
    ...
    TAP_SPEKTRAL_ATTR(gain, kernel::p_gain, 0.0, "Output gain in dB.")
...
#undef TAP_SPEKTRAL_ATTR
    ...
    attribute<int> lfodest{this, "lfodest", kernel::dest_off, setter{ MIN_FUNCTION {
    ...
    attribute<int> bands{this, "bands", kernel::k_default_bands, setter{ MIN_FUNCTION {
                             const int v =
                                 std::clamp(static_cast<int>(args[0]), kernel::k_min_bands, kernel::k_max_bands);
    ...
    message<> gains{this, "gains",
                    ...
                    MIN_FUNCTION {
                        curve_message(kernel::curve_level, args);
                        return {};
                    }};
    ...
    message<> delays{this, "delays",
                     ...
                     "[band value].",
                     MIN_FUNCTION {
                         curve_message(kernel::curve_delay, args);
                         return {};
                     }};
    ...
    message<> fbs{this, "fbs",
                  ...
                  "[band value].",
                  MIN_FUNCTION {
                      curve_message(kernel::curve_fb, args);
                      return {};
                  }};
