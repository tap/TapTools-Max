...
class gang : public object<gang> {
  public:
    ...
    message<> number{this, "number", "A number received at any inlet updates the other three outlets.",
                     MIN_FUNCTION{const double v = bitsafe(static_cast<double>(args[0]));
...
message<> list_msg{this, "list", "A list received at any inlet updates the other three outlets.",
                   MIN_FUNCTION{if (!list_changed(args)){return {};
}
m_list.clear();
...
queue<> m_q0{this, MIN_FUNCTION{send_to(0);
return {};
}
}
;
queue<> m_q1{this, MIN_FUNCTION{send_to(1);
return {};
}
}
;
queue<> m_q2{this, MIN_FUNCTION{send_to(2);
return {};
}
}
;
queue<> m_q3{this, MIN_FUNCTION{send_to(3);
return {};
}
}
;
