...
class zerox : public object<zerox>, public sample_operator<1, 2> {
  public:
    ...
    attribute<int> size{this, "size", 2000, setter{MIN_FUNCTION{const int s = std::max(1, static_cast<int>(args[0]));
...
message<> clear{this, "clear", "Reset the analysis state.", MIN_FUNCTION{m_last_over_zero = false;
m_counter  = 0;
m_final    = 0.0;
m_location = 0;
return {};
