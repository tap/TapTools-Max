...
#define TAP_PITCHACCUM_ATTR(NAME, INDEX, DEFAULT, DESC)                                            \
    ...
    TAP_PITCHACCUM_ATTR(trans2, kernel::p_trans2, 0.0,
        "Transposition of voice 2 in semitones (-24..24).")
    TAP_PITCHACCUM_ATTR(delay1, kernel::p_delay1, 0.0,
        "Delay of voice 1 in ms (0..3000).")
    TAP_PITCHACCUM_ATTR(delay2, kernel::p_delay2, 0.0,
        "Delay of voice 2 in ms (0..3000).")
    ...
    TAP_PITCHACCUM_ATTR(fb2, kernel::p_fb2, 0.0,
        "Feedback of voice 2 (0..99).")
    TAP_PITCHACCUM_ATTR(gain1, kernel::p_gain1, 50.0,
        "Gain of voice 1 (0..100, linear).")
    TAP_PITCHACCUM_ATTR(gain2, kernel::p_gain2, 50.0,
        "Gain of voice 2 (0..100, linear).")
    ...
    TAP_PITCHACCUM_ATTR(modfreq, kernel::p_modfreq, 1.0,
        "Periodic (LFO) modulation frequency in Hz (0..20).")
    TAP_PITCHACCUM_ATTR(moddepth, kernel::p_moddepth, 0.0,
        "Periodic modulation depth in semitones (0..24).")
    ...
    TAP_PITCHACCUM_ATTR(randrate, kernel::p_randrate, 5.0,
        "Random modulation rate in Hz (0..50).")

    // -- globals ------------------------------------------------------------------------------------

    TAP_PITCHACCUM_ATTR(mix, kernel::p_mix, 50.0,
        "Dry/wet crossfade (0 = dry .. 100 = wet), equal-power.")
    TAP_PITCHACCUM_ATTR(gain, kernel::p_gain, 0.0,
        "Output gain in dB.")

#undef TAP_PITCHACCUM_ATTR

    attribute<bool> follow { this, "follow", false,
        setter { MIN_FUNCTION {
