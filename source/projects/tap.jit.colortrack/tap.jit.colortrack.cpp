...
static constexpr int k_hue        = 1;
static constexpr int k_saturation = 2;
static constexpr int k_lightness  = 3; // a.k.a. BRIGHTNESS / LUMINANCE in the original

static constexpr int k_num_trackers = 4;
static constexpr int k_num_planes   = 4;
...
static void rgb2hsl(unsigned char red, unsigned char green, unsigned char blue, short* hue, short* saturation,
                    short* lightness) {
    short max, min;
    short L, S = 0;
    float H = 0;
...
class jit_colortrack : public object<jit_colortrack> {
  public:
    ...
    jit_colortrack(const atoms& args = {}) {
        ...
        for (int t = 0; t < k_num_trackers; ++t) {
            recompute_hue(t);
    ...
    attribute<bool> output_bounds_1{this, "output_bounds_1", false,
                                    setter{MIN_FUNCTION{ return set_bounds(0, args); }},
                                    description{"When 1, output the bounds of color tracker 1."}};
    attribute<bool> output_center_1{this, "output_center_1", false,
                                    setter{MIN_FUNCTION{ return set_center(0, args); }},
                                    description{"When 1, output the center of color tracker 1."}};
    attribute<bool> output_size_1{this, "output_size_1", false,
                                  setter{MIN_FUNCTION{ return set_size(0, args); }},
                                  description{"When 1, output the size of color tracker 1."}};

    attribute<bool> output_bounds_2{this, "output_bounds_2", false,
                                    setter{MIN_FUNCTION{ return set_bounds(1, args); }},
                                    description{"When 1, output the bounds of color tracker 2."}};
    attribute<bool> output_center_2{this, "output_center_2", false,
                                    setter{MIN_FUNCTION{ return set_center(1, args); }},
                                    description{"When 1, output the center of color tracker 2."}};
    attribute<bool> output_size_2{this, "output_size_2", false,
                                  setter{MIN_FUNCTION{ return set_size(1, args); }},
                                  description{"When 1, output the size of color tracker 2."}};

    attribute<bool> output_bounds_3{this, "output_bounds_3", false,
                                    setter{MIN_FUNCTION{ return set_bounds(2, args); }},
                                    description{"When 1, output the bounds of color tracker 3."}};
    attribute<bool> output_center_3{this, "output_center_3", false,
                                    setter{MIN_FUNCTION{ return set_center(2, args); }},
                                    description{"When 1, output the center of color tracker 3."}};
    attribute<bool> output_size_3{this, "output_size_3", false,
                                  setter{MIN_FUNCTION{ return set_size(2, args); }},
                                  description{"When 1, output the size of color tracker 3."}};

    attribute<bool> output_bounds_4{this, "output_bounds_4", false,
                                    setter{MIN_FUNCTION{ return set_bounds(3, args); }},
                                    description{"When 1, output the bounds of color tracker 4."}};
    attribute<bool> output_center_4{this, "output_center_4", false,
                                    setter{MIN_FUNCTION{ return set_center(3, args); }},
                                    description{"When 1, output the center of color tracker 4."}};
    attribute<bool> output_size_4{this, "output_size_4", false,
                                  setter{MIN_FUNCTION{ return set_size(3, args); }},
    ...
    attribute<int> hue_variation_1{this, "hue_variation_1", 0,
                                   setter{MIN_FUNCTION{ return set_hue_var(0, args); }},
    ...
    attribute<int> hue_variation_2{this, "hue_variation_2", 0,
                                   setter{MIN_FUNCTION{ return set_hue_var(1, args); }},
    ...
    attribute<int> hue_variation_3{this, "hue_variation_3", 0,
                                   setter{MIN_FUNCTION{ return set_hue_var(2, args); }},
    ...
    attribute<int> hue_variation_4{this, "hue_variation_4", 0,
                                   setter{MIN_FUNCTION{ return set_hue_var(3, args); }},
                                   description{"Acceptable hue variation for tracker 4 (degrees)."}};

    attribute<int> saturation_1{this, "saturation_1", 0,
                                setter{MIN_FUNCTION{ return set_sat(0, args); }},
                                description{"Saturation to match for tracker 1 (0-255)."}};
    attribute<int> saturation_variation_1{this, "saturation_variation_1", 0,
                                          setter{MIN_FUNCTION{ return set_sat_var(0, args); }},
                                          description{"Acceptable saturation variation for tracker 1 (0-255)."}};
    attribute<int> saturation_2{this, "saturation_2", 0,
                                setter{MIN_FUNCTION{ return set_sat(1, args); }},
                                description{"Saturation to match for tracker 2 (0-255)."}};
    attribute<int> saturation_variation_2{this, "saturation_variation_2", 0,
                                          setter{MIN_FUNCTION{ return set_sat_var(1, args); }},
                                          description{"Acceptable saturation variation for tracker 2 (0-255)."}};
    attribute<int> saturation_3{this, "saturation_3", 0,
                                setter{MIN_FUNCTION{ return set_sat(2, args); }},
                                description{"Saturation to match for tracker 3 (0-255)."}};
    attribute<int> saturation_variation_3{this, "saturation_variation_3", 0,
                                          setter{MIN_FUNCTION{ return set_sat_var(2, args); }},
                                          description{"Acceptable saturation variation for tracker 3 (0-255)."}};
    attribute<int> saturation_4{this, "saturation_4", 0,
                                setter{MIN_FUNCTION{ return set_sat(3, args); }},
                                description{"Saturation to match for tracker 4 (0-255)."}};
    attribute<int> saturation_variation_4{this, "saturation_variation_4", 0,
                                          setter{MIN_FUNCTION{ return set_sat_var(3, args); }},
                                          description{"Acceptable saturation variation for tracker 4 (0-255)."}};

    attribute<int> brightness_1{this, "brightness_1", 0,
                                setter{MIN_FUNCTION{ return set_bri(0, args); }},
                                description{"Brightness to match for tracker 1 (0-255)."}};
    attribute<int> brightness_variation_1{this, "brightness_variation_1", 0,
                                          setter{MIN_FUNCTION{ return set_bri_var(0, args); }},
                                          description{"Acceptable brightness variation for tracker 1 (0-255)."}};
    attribute<int> brightness_2{this, "brightness_2", 0,
                                setter{MIN_FUNCTION{ return set_bri(1, args); }},
                                description{"Brightness to match for tracker 2 (0-255)."}};
    attribute<int> brightness_variation_2{this, "brightness_variation_2", 0,
                                          setter{MIN_FUNCTION{ return set_bri_var(1, args); }},
                                          description{"Acceptable brightness variation for tracker 2 (0-255)."}};
    attribute<int> brightness_3{this, "brightness_3", 0,
                                setter{MIN_FUNCTION{ return set_bri(2, args); }},
                                description{"Brightness to match for tracker 3 (0-255)."}};
    attribute<int> brightness_variation_3{this, "brightness_variation_3", 0,
                                          setter{MIN_FUNCTION{ return set_bri_var(2, args); }},
                                          description{"Acceptable brightness variation for tracker 3 (0-255)."}};
    attribute<int> brightness_4{this, "brightness_4", 0,
                                setter{MIN_FUNCTION{ return set_bri(3, args); }},
                                description{"Brightness to match for tracker 4 (0-255)."}};
    attribute<int> brightness_variation_4{this, "brightness_variation_4", 0,
                                          setter{MIN_FUNCTION{ return set_bri_var(3, args); }},
                                          description{"Acceptable brightness variation for tracker 4 (0-255)."}};

    message<> jit_matrix{
        this, "jit_matrix", "Analyze the named matrix and output tracker results.",
        MIN_FUNCTION{
            if (args.empty()) {
                return {};
            }
  ...
  private:
    ...
    char m_use[k_num_trackers]{};
    // Indicates that the hue match range crosses 0 on the color wheel.
    char m_hue_check[k_num_trackers]{};
    // Low/high bounds (HSL planes; alpha plane unused), derived from the public attributes.
    long m_min[k_num_trackers][k_num_planes]{};
    long m_max[k_num_trackers][k_num_planes]{};

    // Stored attribute values (mirror of the public attributes, for the derivation math).
    long m_hue[k_num_trackers]{}, m_hue_var[k_num_trackers]{};
    long m_sat[k_num_trackers]{}, m_sat_var[k_num_trackers]{};
    long m_bri[k_num_trackers]{}, m_bri_var[k_num_trackers]{};
    bool m_bounds[k_num_trackers]{}, m_center[k_num_trackers]{}, m_size[k_num_trackers]{};

    void recompute_hue(int t) {
        m_min[t][k_hue] = onewrap(m_hue[t] - m_hue_var[t], 0L, 359L);
        m_max[t][k_hue] = onewrap(m_hue[t] + m_hue_var[t], 0L, 359L);
        m_hue_check[t]  = (m_min[t][k_hue] > m_max[t][k_hue]) ? 1 : 0;
    }
    void recompute_saturation(int t) {
        m_min[t][k_saturation] = ttclip(m_sat[t] - m_sat_var[t], 0L, 255L);
        m_max[t][k_saturation] = ttclip(m_sat[t] + m_sat_var[t], 0L, 255L);
    }
    void recompute_brightness(int t) {
        m_min[t][k_lightness] = ttclip(m_bri[t] - m_bri_var[t], 0L, 255L);
        m_max[t][k_lightness] = ttclip(m_bri[t] + m_bri_var[t], 0L, 255L);
    }
    void recompute_use(int t) { m_use[t] = (m_bounds[t] || m_center[t] || m_size[t]) ? 1 : 0; }
    ...
    void calculate(long* dim, const mx::t_jit_matrix_info& info, char* bip) {
        ...
        long min_x[k_num_trackers], min_y[k_num_trackers], max_x[k_num_trackers], max_y[k_num_trackers];
        for (int t = 0; t < k_num_trackers; ++t) {
            min_x[t] = min_y[t] = 0x7FFFFFFF; // a really high number — looking for a smaller pixel
            max_x[t] = max_y[t] = -1;
        }

        char inrange_flag_x[k_num_trackers];
        char inrange_flag_y[k_num_trackers];
        ...
        for (long i = 0; i < dim[1]; ++i) { // ITERATE THROUGH THE Y-AXIS
            ...
            for (long j = 0; j < n; ++j) { // ITERATE THROUGH THE X-AXIS
                ...
                for (int tracker = 0; tracker < k_num_trackers; ++tracker) {
                    if (!m_use[tracker]) {
                        continue;
                    }
                    ...
                    if (m_hue_check[tracker]) { // HUE — range crosses 0 on the color wheel
                        if (hue > m_min[tracker][k_hue]) {
                            inrange_flag_x[tracker] = 0;
                        }
                        else if (hue < m_max[tracker][k_hue]) {
                            inrange_flag_x[tracker] = 0;
                        }
                    }
                    else { // HUE — normal
                    ...
                    if (saturation < m_min[tracker][k_saturation]) { // SATURATION
                        inrange_flag_x[tracker] = 0;
                    }
                    else if (saturation > m_max[tracker][k_saturation]) {
                        inrange_flag_x[tracker] = 0;
                    }

                    if (lightness < m_min[tracker][k_lightness]) { // LIGHTNESS
                        inrange_flag_x[tracker] = 0;
                    }
                    else if (lightness > m_max[tracker][k_lightness]) {
                        inrange_flag_x[tracker] = 0;
                    }
        ...
        for (int tracker = 0; tracker < k_num_trackers; ++tracker) {
            ...
            if (m_bounds[tracker]) {
                m_out.send(tracker + 1, "bounds", normalized_bounds[0], normalized_bounds[1], normalized_bounds[2],
                           normalized_bounds[3]);
            }
            if (m_center[tracker]) {
                m_out.send(tracker + 1, "center", (normalized_bounds[2] + normalized_bounds[0]) * 0.5,
